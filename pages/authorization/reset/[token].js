      ...
      <form className={styles.form}>
        ...
        <div className={styles.formBlock}>
          ...
          <input
            ...
            className={classNames(
              { [styles.warningInput]: passwordEmpty },
              styles.input
            )}
        ...
        <div className={styles.formBlock}>
          ...
          <input
            ...
            autoComplete="new-password"
            className={classNames(
              { [styles.warningInput]: passConfirmEmpty },
              styles.input
            )}
        ...
        {isLoading && (
          <p className={styles.warning}>Идёт обновление пароля...</p>
        )}
        {emptyField && <p className={styles.warning}>Заполните все поля!</p>}

        {invalidPassword && (
          <p className={styles.warning}>
            Пароль должен состоять из латинских букв или цифр. Длина пароля
            минимум 8 букв
          </p>
        )}
        {passWordsDiffer && (
          <p className={styles.warning}>Пароли не совпадают</p>
        )}
        {passChanged && (
          <p className={styles.warning}>Пароль успешно обновлён!</p>
        )}
      </form>
