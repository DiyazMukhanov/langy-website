...
export default function Confidentiality() {
    ...
    <div className={styles.container}>
        ...
        <div>
Настоящая Политика конфиденциальности персональных данных (далее – Политика конфиденциальности) является публичным Договором, заключенным между владельцем сайте langy.su ИП Куанышева  (Продавец) и Покупателем в соответствии со ст.387 Гражданского кодекса Республики Казахстан, основана на Законе Республики Казахстан «О персональных данных и их защите», действует в отношении информации, содержащей персональные данные Покупателей, которую сайт  https:// langy.su (далее – langy.su) может получить о Покупателях во время пользования ими сайтом langy.su.
</div>
<div>
...
1.6. Интернет-сайт langy.su, расположенный на сервере в г. Алматы и имеющий адрес в сети Интернет https:// langy.su, на котором размещен курс анлийского языка, а также условия оплаты и предоставления подписки пользователям.
1.7. Сервисы Интернет-сайта – все услуги, доступные для использования на сайте https:// langy.su и поддоменах.
1.8. Покупатель – пользователь Интернет-сайта langy.su.
1.9. Продавец – ИП Куанышева, являющееся владельцем Интернет-сайта langy.su, ИИН 870429402431.
1.10. Cookies — это небольшие текстовые файлы, в которые браузер записывает данные с посещенных Покупателями сайтов. Cookies исполняют целый ряд функций, например, позволяют Покупателю эффективно перемещаться между страницами, запоминая его предпочтения, и, таким образом, улучшает опыт взаимодействия с Интернет-сайтом. Они также могут способствовать тому, что реклама, которую видит Покупатель онлайн, соответствует его интересам. Если не использовать cookies, то не возможно будет проходить обучение на сайте langy.su, так как вся работа сайта построена на сохранении данных с этих файлов. 
1.11. IP-адрес — уникальный сетевой адрес узла в компьютерной сети, построенной по протоколу IP, позволяющий определить местонахождение Покупателя. Интернет-сайт langy.su не отслеживает местоположение, подробнее чем город и область.

<div>
2. Предмет политики конфиденциальности
</div>

2.1. Настоящая Политика конфиденциальности устанавливает обязательства Продавца по неразглашению и обеспечению режима защиты конфиденциальности персональных данных, которые Покупатель предоставляет по запросу langy.su при регистрации на сайте langy.su и/или при оформлении заказа для приобретения подписки.
2.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются Покупателем путём заполнения регистрационной формы на сайте langy.su и включают в себя следующую информацию:
...
3.1. Продавец собирает, обрабатывает и хранит только те персональные данные, которые необходимы для предоставления Сервисов.
...
4.1.1. предоставлять информацию о персональных данных, необходимую для пользования Интернет-сайтом;
4.1.2. изменять, дополнять предоставленную информацию в случае обнаружения некорректных данных при пользовании Интернет- сайтом.
...
4.3.2. обеспечить хранение конфиденциальной информации в тайне, не разглашать без предварительного письменного разрешения Покупателя переданных персональных данных, а также уполномоченным государственным органам Республики Казахстан в порядке, установленным законодательством РК;
...
4.4. Продавец имеет право предоставлять доступ для сбора и анализа неличных данных Покупателей третьим лицам для целей статистики и оптимизации рекламных сообщений. Использование неличных данных третьими лицами регулируется их собственными политиками конфиденциальности, и Интернет-сайт langy.su не несет ответственности за их использование.

<div>
5. Прочие условия
</div>

5.1. Пользование Покупателем Интернет-сайтом langy.su означает его безоговорочное согласие с настоящей Политикой конфиденциальности и условиями обработки Продавцом персональных данных Покупателя.
5.2. В случае несогласия с условиями Политики конфиденциальности Покупатель должен прекратить пользование Сайтом langy.su.
5.3. Настоящая Политика конфиденциальности применяется только к сайту https://.langy.su и поддоменам. Интернет-сайт langy.su  не несет ответственность за сайты третьих лиц, на которые Покупатель может перейти по ссылкам, доступным на сайте langy.su.
...
5.5. Отключение Сookies может повлечь невозможность доступа к частям сайта langy.su, требующим авторизации.
5.6. Интернет-сайт langy.su осуществляет сбор статистики об IP-адресах своих Покупателей. Данная информация используется с целью выявления и решения технических проблем, для контроля законности проводимых финансовых платежей.
...
5.9. Все предложения или вопросы по поводу настоящей Политики конфиденциальности следует сообщать по адресу: admin@langy.su.
