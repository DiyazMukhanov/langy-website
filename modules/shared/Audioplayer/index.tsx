...
const Audioplayer = memo(function Audioplayer({ audioSrc }: { audioSrc: string }) {
    ...
    const progressUpdate = useCallback(() => {
        ...
        if (progressBarRef !== null && progressBarRef.current !== null && progressBarRef.current) {
    ...
    return <>{hasWindow && <audio src={audioSrc} ref={audioRef} preload="metadata" onLoadedMetadata={onLoadedMetadata} />}
