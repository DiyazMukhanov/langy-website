...
export default function BeginnerLessonLayout({
  ...
  useEffect(() => {
    const updateBeginnerProgressHandlerInit = async () => {
      try {
        const response = await updateBeginnerProgress(
          updateCurrentBeginnerProgressBody
        );
      ...
      <ProtectPage>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.rightSide}>
            ...
            {isCardLesson && <CardLesson words={words} />}
            ...
            <div className={styles.btnContainer}>
              <Button
                ...
                onClick={
                  !isNextToElementary
                    ? () =>
                        updateBeginnerProgressHandler(
                          updateNextBeginnerProgressBody,
                          true
                        )
                    : exitBeginnerHandler
                }
