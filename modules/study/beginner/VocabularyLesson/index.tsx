  ...
  return (
    <div className={styles.vocabularyLessonContainer}>
      ...
      <div className={styles.wordsContainer}>
        <div className={styles.top}>
          {!rightStateIndexes[findIndexOfRightWord(wordsToAsk[0].enWord)] ? (
            <DragDropContainer targetKey="foo" dragData={wordsToAsk[0].enWord}>
          ...
          {!rightStateIndexes[findIndexOfRightWord(wordsToAsk[1].enWord)] ? (
            <DragDropContainer targetKey="foo" dragData={wordsToAsk[1].enWord}>
          ...
          {!rightStateIndexes[findIndexOfRightWord(wordsToAsk[2].enWord)] ? (
            <DragDropContainer targetKey="foo" dragData={wordsToAsk[2].enWord}>
        ...
        <div className={styles.bottom}>
          {firstRight ? (
            <div className={styles.dropTargetRight}>
              {words[0].enWord} - {words[0].ruWord}
            </div>
          ) : (
            <div className={styles.dropTargetFrame}>
              <DropTarget
                targetKey="foo"
                onHit={(e) => onDropHandler(e, words[0].enWord)}
              >
          ...
          {secondRight ? (
            <div className={styles.dropTargetRight}>
              {words[1].enWord} - {words[1].ruWord}
            </div>
          ) : (
            <div className={styles.dropTargetFrame}>
              <DropTarget
                targetKey="foo"
                onHit={(e) => onDropHandler(e, words[1].enWord)}
              >
                <div className={styles.dropTarget}>
          ...
          {thirdRight ? (
            <div className={styles.dropTargetRight}>
              {words[2].enWord} - {words[2].ruWord}
            </div>
          ) : (
            <div className={styles.dropTargetFrame}>
              <DropTarget
                targetKey="foo"
                onHit={(e) => onDropHandler(e, words[2].enWord)}
              >
                <div className={styles.dropTarget}>
      ...
      <div className={styles.moreBtn}>
        <UpdateButton onClick={nextWordsHandler} />
      </div>
