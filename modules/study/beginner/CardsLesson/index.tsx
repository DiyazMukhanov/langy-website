...
export default function CardLesson({ words }) {
  ...
  const createTranslationCard = (wordObject) => {
    ...
    if (randomShowingVariant === 0) {
      translationsArray = [
        wordObject.enRight,
        wordObject.enWrong[0],
        wordObject.enWrong[1],
      ];
    }
    ...
    return (
      <>
        {translationsArray.map((item, index) => (
          <div
            key={index}
            className={classNames(styles.translationCard, {
  ...
  return (
    <div className={styles.container}>
      <p className={styles.task}>Выберите верное слово</p>
      ...
      <div className={styles.bottomContainer}>
        ...
        <div className={styles.btnContainer}>
          <UpdateButton onClick={moreWordsHandler} />
