...
import { getAllServices } from "./shared/api/getAllServices";
import { showNotResolvedService } from "./shared/api/showNotResolvedService";
          ...
          <div className={styles.dataContainer}>
            {data.map((item) => (
              <p
                ...
                onClick={() =>
                  router.push(`/admin/service-profile/${item._id}`)
                }
              >
