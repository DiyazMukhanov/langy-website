      ...
      <form className={styles.form} onSubmit={forgotHandler}>
        ...
        <div className={styles.formBlock}>
          ...
          <input
            ...
            className={classNames(
              { [styles.warningInput]: emptyField },
              styles.input
            )}
        ...
        {error && (
          <p className={styles.warning}>
            Неправильный почтовый адрес или пароль
          </p>
        )}
        {emptyField && (
          <p className={styles.warning}>Введите почтовый адрес!</p>
        )}
        {invalidEmail && (
          <p className={styles.warning}>Введите валидный почтовый адрес!</p>
        )}
      </form>
    </div>
  );
